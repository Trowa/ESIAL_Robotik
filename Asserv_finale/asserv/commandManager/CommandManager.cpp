 ...
 * (0,0) est la position initiale du robot après calage bordure OU coin de la table
...
void CommandManager::computeGoTo(){
  ...
  // Exemple, tourner de 200 degrés est plus chiant que de tourner de -160 degrés
  if ( deltaTheta > PI ){
    deltaTheta -= 2.0*PI;
